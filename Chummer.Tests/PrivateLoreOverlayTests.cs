...
public sealed class PrivateLoreOverlayTests
{
    ...
    public void PrivateLoreOverlay_route_and_public_blocking_contract_exist()
    {
        ...
        string landingController = File.ReadAllText(RepoPaths.FromRoot("Chummer.Run.Api", "Controllers", "PublicLandingController.cs"));
        ...
        Assert.Contains("Private lore overlays can exist here for campaign context, but public Ledger routes must never render them.", landingController, StringComparison.Ordinal);
