...
public sealed class VerificationEntryPointTests
{
    ...
    public void SignedInReleaseUploadHandoffIsPublishedFromPortal()
    {
        ...
        Assert.Contains("keeps it off the copied bootstrap command", controller, StringComparison.Ordinal);
        ...
        Assert.Contains("prompts for the current short-lived upload handoff code", view, StringComparison.Ordinal);
        Assert.Contains("This command intentionally omits the handoff code", view, StringComparison.Ordinal);
        Assert.Contains("Short-lived handoff code", view, StringComparison.Ordinal);
        Assert.Contains("Paste this only when the bootstrap prompts", view, StringComparison.Ordinal);
        ...
        Assert.Contains("keeps it off the command line", maintenanceReadme, StringComparison.Ordinal);
        ...
        Assert.Contains("keeps the short-lived upload handoff code off the command line", publicReadme, StringComparison.Ordinal);
