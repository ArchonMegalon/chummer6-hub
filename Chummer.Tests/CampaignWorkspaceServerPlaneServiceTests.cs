...
public sealed class CampaignWorkspaceServerPlaneServiceTests
{
    ...
    public void PrepLibraryQueryMatchingSupportsOpForShorthandAcrossWhitespaceAndPunctuation()
    {
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("oppositionwindow")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("oppositionwindows")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("oppositioncontrol")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("oppositioncontrols")));
    ...
    public void PrepLibraryQueryMatchingSupportsCompactGovernedPacketForms()
    {
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostermovepkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostermovementpacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostermovementpkt")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovepacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovepackets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovepkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovepkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovementpacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovementpackets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovementpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovementpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovebrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovebriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovebrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovebrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovementbrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovementbriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovementbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("rostersmovementbrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("eventcontrolpacket")));
    ...
    public void PrepLibraryQueryMatchingSupportsCompactContinuityAndGmPacketForms()
    {
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignreturnbrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignsreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignsreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignsreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignsreturnbrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("aftermathreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("aftermathreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("aftermathreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("aftermathreturnbrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("aftermathsreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("aftermathsreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("aftermathsreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("aftermathsreturnbrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("downtimereturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("downtimereturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("downtimereturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("downtimereturnbrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("downtimesreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("downtimesreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("downtimesreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("downtimesreturnbrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diariesreturnloop")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diaryreturnloop")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diariesreturnbriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diariesreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diariesreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diariesreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diariesreturnbrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diaryreturnpacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diaryreturnpackets")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diaryreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diaryreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diaryreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("diaryreturnbrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("contactsreturnbriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("contactsreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("contactsreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("contactsreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("contactsreturnbrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("contactreturnpacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("contactreturnpackets")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("contactreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("contactreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("contactreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("contactreturnbrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatsreturnbriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatsreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatsreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatsreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatsreturnbrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatreturnpacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatreturnpackets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatreturnbrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatreturnbriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("heatreturnbrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travelofflinepkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travelofflinepkts")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travelofflinebrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travelofflinebrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travelsofflinepacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travelsofflinepackets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travelsofflinepkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travelsofflinepkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travelsofflinebrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travelsofflinebriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travelsofflinebrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travelsofflinebrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobileofflinepkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobileofflinepkts")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobileofflinebrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobileofflinebrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousetravelpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousetravelpkts")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousetravelbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousetravelbrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousestravelpacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousestravelpackets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousestravelpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousestravelpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousestravelbrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousestravelbriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousestravelbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousestravelbrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouseofflinepacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouseofflinepackets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouseofflinepkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouseofflinepkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouseofflinebrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouseofflinebriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouseofflinebrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouseofflinebrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousesofflinepacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousesofflinepackets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousesofflinepkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousesofflinepkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousesofflinebrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousesofflinebriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousesofflinebrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehousesofflinebrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehouseofflinepacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehouseofflinepackets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehouseofflinepkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehouseofflinepkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehouseofflinebrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehouseofflinebriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehouseofflinebrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehouseofflinebrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehousesofflinepacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehousesofflinepackets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehousesofflinepkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehousesofflinepkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehousesofflinebrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehousesofflinebriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehousesofflinebrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilesafehousesofflinebrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travel-offline-packet")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("travel-offline-packets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobile offline packet")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobile offline packets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobile-offline-packet")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobile-offline-packets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouse travel packet")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouse travel packets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouse-travel-packet")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouse-travel-packets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouse offline packet")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouse offline packets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouse-offline-packet")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("safehouse-offline-packets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobile safehouse offline packet")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobile safehouse offline packets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobile-safehouse-offline-packet")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobile-safehouse-offline-packets")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmoperationspacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmcontrolpacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmcontrolspacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmopspkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmoperationpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmoperationspkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmcontrolpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmcontrolspkt")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmoperationsbrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmcontrolbrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmcontrolsbrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmopsbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmoperationbrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmoperationsbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmcontrolbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gmcontrolsbrf")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemasteroperationspacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemastercontrolpacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemastercontrolspacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemasteropspkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemasteroperationpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemasteroperationspkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemastercontrolpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemastercontrolspkt")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemasteroperationsbrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemastercontrolbrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemastercontrolsbrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemasteropsbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemasteroperationbrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemasteroperationsbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemastercontrolbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("gamemastercontrolsbrf")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("workspacev4packets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("workspacev4brief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("workspacev4briefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignworkspacev4packet")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignworkspacev4packets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignworkspacev4brief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignworkspacev4briefs")));
    ...
    public void PrepLibraryQueryMatchingSupportsNextSessionReturnLoopShorthandAcrossWhitespaceAndPunctuation()
    {
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionreturnpacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionreturnpackets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionreturnbrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionreturnbriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionreturnbrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionsreturnpacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionsreturnpackets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionsreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionsreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionsreturnbrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionsreturnbriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionsreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("nextsessionsreturnbrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("sessionreturnpacket")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("sessionreturnpackets")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("sessionreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("sessionreturnpkts")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("sessionreturnbrief")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("sessionreturnbriefs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("sessionreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("sessionreturnbrfs")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("sessionreturnloop")));
    ...
    public void PrepLibraryQueryMatchingCollapsesTravelOfflineReadinessShorthand()
    {
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobiletravelreadiness")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobiletravelreadinesses")));
    ...
    public void PrepLibraryQueryMatchingCollapsesCompactMobileCompanionReturnLoopForms()
    {
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilecompanionreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilecompanionsreturnpkts")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilecompanionreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("mobilecompanionsreturnbrfs")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignmobilecompanionreturnpkt")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignmobilecompanionsreturnpkts")));
        ...
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignmobilecompanionreturnbrf")));
        Assert.True(InvokeMatches(packet, InvokeBuildTokens("campaignmobilecompanionsreturnbrfs")));
        Assert.False(InvokeMatches(packet, InvokeBuildTokens("matrixreturnloop")));
    }
    ...
    public void PrepLibraryQueryMatchingSupportsCrewTransferShorthandAcrossWhitespaceBoundaries()
    {
        ...
        IReadOnlyList<string> compactRosterTransferTokens = InvokeBuildTokens("rostertransfer");
        IReadOnlyList<string> compactRosterTransfersTokens = InvokeBuildTokens("rostertransfers");
        ...
        IReadOnlyList<string> compactRosterHandoffTokens = InvokeBuildTokens("rosterhandoff");
        IReadOnlyList<string> compactRosterHandoffsTokens = InvokeBuildTokens("rosterhandoffs");
        ...
        Assert.True(InvokeMatches(packet, compactRosterTransferTokens));
        Assert.True(InvokeMatches(packet, compactRosterTransfersTokens));
        Assert.True(InvokeMatches(packet, splitRosterHandoffsTokens));
        Assert.True(InvokeMatches(packet, splitRosterHandoffTokens));
        Assert.True(InvokeMatches(packet, compactRosterHandoffTokens));
        Assert.True(InvokeMatches(packet, compactRosterHandoffsTokens));
