...
public sealed class TrustPageFlagshipViewTests
{
    ...
    public void TrustPageBranchesIntoRouteSpecificHelpContactAndPolicySystems()
    {
        ...
        Assert.Contains("<h2>Discord or private</h2>", trustView, StringComparison.Ordinal);
    ...
    public void ContactSupportPageShowsRouteChoicesBeforeTheFormFields()
    {
        ...
        int routeChoiceIndex = trustView.IndexOf("Discord for normal questions. Private form for account or crash details.", StringComparison.Ordinal);
