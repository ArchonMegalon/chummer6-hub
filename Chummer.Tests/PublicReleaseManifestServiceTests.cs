...
public sealed class PublicReleaseManifestServiceTests
{
    ...
    [Fact]
    public void LoadManifestPreservesExistingCoverageIncompleteRolloutWhenDesktopClientCoverageIsMissing()
    {
        using var fixture = new PublicReleaseManifestFixture();
        fixture.WriteRegistryManifestRaw(new Dictionary<string, object?>
        {
        ...
        Assert.Contains("still catching up", manifest.RolloutReason, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("parity claims remain blocked", manifest.RolloutReason, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("desktop_client", manifest.SupportabilitySummary, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("Check the live download page again", manifest.FixAvailabilitySummary, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("Chummer support", manifest.FixAvailabilitySummary, StringComparison.OrdinalIgnoreCase);
    }
