...
public sealed class SignedInShellContinuityViewTests
{
    ...
    public void AccountViewPublishesOriginDossierLibraryWithPlainReadyLabels()
    {
        ...
        Assert.Contains("The first handoff is the full ebook with its fitted cover", view, StringComparison.Ordinal);
        Assert.Contains("same approved story", view, StringComparison.Ordinal);
        Assert.Contains("cover ships with the ebook handoff", view, StringComparison.Ordinal);
        ...
        Assert.Contains("data-fitted-cover-art-uses-selected-character-face", view, StringComparison.Ordinal);
        ...
        Assert.Contains("Ebook locked", view, StringComparison.Ordinal);
    ...
    public void AccountControllerAndViewPublishAuthenticatedOriginDossierDetailSurface()
    {
        ...
        Assert.Contains("data-fitted-cover-art-uses-selected-character-face", detailView, StringComparison.Ordinal);
        ...
        Assert.Contains("Edition pipeline", detailView, StringComparison.Ordinal);
        Assert.Contains("Fitted cover art", detailView, StringComparison.Ordinal);
        Assert.Contains("private ebook with its fitted cover first", detailView, StringComparison.Ordinal);
        ...
        Assert.Contains("Cinematic render locked", detailView, StringComparison.Ordinal);
