...
{
    // Backward-compatible constructor for consumers compiled against the prior 7-parameter shape.
    public GatewayStatus(
        ...
        : this(
            ...
            SelectionVisibility: new GatewaySelectionVisibility(
                TotalRoutes: 0,
                TotalFallbackRoutes: 0,
                Providers: Array.Empty<ProviderSelectionStatus>(),
                RecentAudits: Array.Empty<GatewayRouteAuditEntry>()),
            UtcNow: utcNow)
    {
    }
}
