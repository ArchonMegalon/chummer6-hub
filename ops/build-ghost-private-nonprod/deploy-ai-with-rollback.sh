...
main() {
    ...
    for required in awk bash cut date df docker find git id jq mv openssl python3 realpath rg rmdir sed seq setsid sha256sum shred sleep stat truncate unlink wc; do
