...
- `Prompting Systems` — Tier 2, staged next. Role: voice tuner for premium copy and media prompt consistency. Target: editorial copy pass templates, image prompt normalization, and route-family tone guardrails. Dependencies: prompt-packet wiring. Verify: prompt packet receipts and review diffs. Touches: design-system copy and creative ops.
