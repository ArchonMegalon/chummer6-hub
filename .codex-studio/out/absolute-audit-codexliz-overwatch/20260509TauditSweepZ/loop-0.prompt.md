...
- a valid close now requires:
  ...
  - `ABSOLUTE_RELEASE_GATES.yaml` pass entries must bind to current-run proof with live repo path, commit SHA, generation time, and real evidence files; blocked entries must include `repo_path`, `blocker`, and `next_action`
  ...
  - `VERIFICATION_COMMANDS.md` must contain structured gate sections with `Owner repo:`, `Command:`, and `Evidence:`
...
- Run ledger: parsed_lines=1 structured_lines=0 pass0_seen=True evidence_rows=0 total_lines=1 (/docker/chummercomplete/_completion/chummer6_absolute_completion/RUN_LEDGER.jsonl)
- Repo inventory: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/REPO_INVENTORY.yaml)
- Repo inventory live reconciliation: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/REPO_INVENTORY.yaml)
- Branch policy alignment: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/REPO_INVENTORY.yaml)
- Estate git state: mismatches=/docker/chummercomplete/Chummer6:dirty_without_inherited_note, /docker/EA:dirty_without_inherited_note, /docker/fleet:dirty_without_inherited_note, /docker/chummercomplete/chummer.run-services:dirty_without_inherited_note, /docker/chummercomplete/chummer-core-engine:dirty_without_inherited_note, /docker/chummercomplete/chummer-presentation:dirty_without_inherited_note, /docker/chummercomplete/chummer-design:dirty_without_inherited_note, /docker/chummercomplete/chummer-hub-registry:dirty_without_inherited_note, /docker/chummercomplete/chummer-play:dirty_without_inherited_note, /docker/chummercomplete/chummer-ui-kit:dirty_without_inherited_note, /docker/fleet/repos/chummer-media-factory:dirty_without_inherited_note, /docker/chummer5a:dirty_without_inherited_note, /docker/fleet/repos/chummer4:dirty_without_inherited_note (/docker/chummercomplete)
- Ownership truth map semantics: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/OWNERSHIP_TRUTH_MAP.yaml)
- Canon truth map semantics: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/CANON_TRUTH_MAP.md)
...
- Bug register semantics: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/BUG_AND_GAP_REGISTER.yaml)
...
- Completion verdict semantics: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/ABSOLUTE_COMPLETION_VERDICT.md)
