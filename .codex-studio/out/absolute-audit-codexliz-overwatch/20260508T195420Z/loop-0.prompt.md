...
- closure gate script: /docker/chummercomplete/chummer.run-services/.codex-studio/scripts/check_absolute_audit_closure.py
- pending ABS ids: ABS-016, ABS-004, ABS-017, ABS-005, ABS-001, ABS-018, ABS-012, ABS-006, ABS-003, ABS-002

Current pending checks:
- Canonical domain policy: missing receipt (/docker/chummercomplete/chummer.run-services/.codex-studio/published/CANONICAL_DOMAIN_POLICY.generated.json)
...
- Live support/contact proof: missing receipt (/docker/chummercomplete/chummer.run-services/.codex-studio/published/SUPPORT_CASE_FLOW_PROOF.generated.json)
- Live Google OAuth/account-linking proof: missing receipt (/docker/chummercomplete/chummer.run-services/.codex-studio/published/GOOGLE_OAUTH_LINKING_PROOF.generated.json)
- Fresh desktop execution proof: missing receipt (/docker/chummercomplete/chummer-presentation/.codex-studio/published/CHUMMER5A_DESKTOP_EXECUTION_PROOF.generated.json)
- Portable receipts audit: missing receipt (/docker/chummercomplete/chummer.run-services/.codex-studio/published/PORTABLE_RECEIPTS_AUDIT.generated.json)
- SR5 closure: need SR5_ACCEPTANCE_PROOF.generated.json or SR5_CLAIM_BOUNDARY.generated.json (/docker/chummercomplete/chummer-core-engine/.codex-studio/published/SR5_ACCEPTANCE_PROOF.generated.json)
- SR4 closure: need SR4_ACCEPTANCE_PROOF.generated.json or SR4_CLAIM_RETIREMENT.generated.json (/docker/chummercomplete/chummer-core-engine/.codex-studio/published/SR4_ACCEPTANCE_PROOF.generated.json)
- SR6 closure: need SR6_ACCEPTANCE_PROOF.generated.json or SR6_CLAIM_RETIREMENT.generated.json (/docker/chummercomplete/chummer-core-engine/.codex-studio/published/SR6_ACCEPTANCE_PROOF.generated.json)
