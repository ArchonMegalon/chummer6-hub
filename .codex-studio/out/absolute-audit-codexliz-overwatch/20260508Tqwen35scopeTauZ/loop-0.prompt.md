...
- if Pass 0 is not materially created early, the supervisor will recycle your loop as non-progress
...
- Estate git state: mismatches=/docker/chummercomplete/Chummer6:dirty, /docker/EA:dirty, /docker/fleet:dirty, /docker/chummercomplete/chummer.run-services:dirty, /docker/chummercomplete/chummer-core-engine:dirty, /docker/chummercomplete/chummer-presentation:dirty, /docker/chummercomplete/chummer-design:dirty, /docker/chummercomplete/chummer-hub-registry:dirty, /docker/chummercomplete/chummer-play:dirty, /docker/chummercomplete/chummer-ui-kit:dirty, /docker/fleet/repos/chummer-media-factory:dirty, /docker/chummer5a:dirty, /docker/fleet/repos/chummer4:dirty (/docker/chummercomplete)
