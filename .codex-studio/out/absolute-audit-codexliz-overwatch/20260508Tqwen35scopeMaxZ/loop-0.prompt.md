...
- a valid close now requires:
  ...
  - `TARGET_PUBLIC_ROUTES.yaml` fully accounted for in the completion artifacts; no required route may disappear from truth mapping, verification, or explicit blockers
