...
- also inspect any additional relevant local repos already mounted under `/docker/chummercomplete` and `/docker/fleet/repos`
...
2. create the required `_completion/chummer6_absolute_completion/` artifacts
