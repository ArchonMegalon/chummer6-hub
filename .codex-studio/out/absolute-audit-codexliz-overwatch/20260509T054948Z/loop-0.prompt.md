...
- pending ABS ids: strict_hub_substance, release_gates_coverage, verification_results_gates, e2e_results_coverage, target_public_routes_coverage
- completion root: /docker/chummercomplete/_completion/chummer6_absolute_completion

Current pending checks:
- Strict hub substance gate: pending=portable_receipts_audit (/docker/chummercomplete/chummer.run-services/scripts/check_absolute_audit_substance.py)
