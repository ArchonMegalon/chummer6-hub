...
- pending ABS ids: ABS-016, ABS-004, ABS-017, ABS-005, ABS-001, ABS-018, ABS-012, ABS-006

Current pending checks:
- Canonical domain policy: status=missing canonical_public_domain='chummer.run' chummer6.run='not_used' (/docker/chummercomplete/chummer.run-services/.codex-studio/published/CANONICAL_DOMAIN_POLICY.generated.json)
...
- Live support/contact proof: status='pass' base_url='https://chummer.run' script='scripts/check-support-case-flow.py' routes_checked=5 stdout_ok=False (/docker/chummercomplete/chummer.run-services/.codex-studio/published/SUPPORT_CASE_FLOW_PROOF.generated.json)
- Live Google OAuth/account-linking proof: status='pass' base_url='https://chummer.run' script='scripts/check-google-oauth-linking.py' script_exists=False test_cases=6 (/docker/chummercomplete/chummer.run-services/.codex-studio/published/GOOGLE_OAUTH_LINKING_PROOF.generated.json)
- Fresh desktop execution proof: status='pass' run_context_timestamp=True receipts_bound=False (/docker/chummercomplete/chummer-presentation/.codex-studio/published/CHUMMER5A_DESKTOP_EXECUTION_PROOF.generated.json)
- Portable receipts audit: status='pass' scanned_artifact_count=None machine_specific_hits=missing (/docker/chummercomplete/chummer.run-services/.codex-studio/published/PORTABLE_RECEIPTS_AUDIT.generated.json)
