...
- pending ABS ids: strict_hub_substance, required_artifacts, run_ledger, branch_policy_alignment, COMPLETION_BACKLOG.yaml, HORIZON_MVP_COMPLETION_MAP.yaml, horizon_mvp_semantics, E2E_RESULTS.generated.json, VERIFICATION_RESULTS.generated.json, verification_commands_coverage, verification_results_gates, e2e_results_coverage, target_public_routes_coverage, false_claim_seed_coverage, ltd_seed_coverage, product_doc_truth_coverage, ABSOLUTE_GAP_AUDIT.md, MISSED_POTENTIAL_AUDIT.md, USER_WISH_DESIGN_EXPANSION.md, LTD_COMPLETION_MAP.md, ABSOLUTE_PRODUCT_COMPLETION_PLAN.md, FEEDBACK_TO_IMPLEMENTATION_LOOP.md, KARMA_FORGE_PRODUCT_AND_IMPLEMENTATION_LOOP.md, PACKAGE_MANAGEMENT_AND_PUBLIC_PACKAGE_BROWSER.md, MOBILE_PWA_PRODUCT_SPEC.md, E2E_TEST_PLAN.md, VERIFICATION_COMMANDS.md, DEV_CHANGE_GUIDE.md, FALSE_CLAIM_RISK.md, PUBLIC_COPY_CHANGE_GUIDE.md, LTD_ADAPTER_IMPLEMENTATION_GUIDE.md, RELEASE_RUNBOOK.md, PREMIUM_FLAGSHIP_POLISH_REPORT.md, ABSOLUTE_GAP_AUDIT.md.semantic, MISSED_POTENTIAL_AUDIT.md.semantic, USER_WISH_DESIGN_EXPANSION.md.semantic, LTD_COMPLETION_MAP.md.semantic, ABSOLUTE_PRODUCT_COMPLETION_PLAN.md.semantic, FEEDBACK_TO_IMPLEMENTATION_LOOP.md.semantic, KARMA_FORGE_PRODUCT_AND_IMPLEMENTATION_LOOP.md.semantic, PACKAGE_MANAGEMENT_AND_PUBLIC_PACKAGE_BROWSER.md.semantic, MOBILE_PWA_PRODUCT_SPEC.md.semantic, E2E_TEST_PLAN.md.semantic, VERIFICATION_COMMANDS.md.semantic, DEV_CHANGE_GUIDE.md.semantic, FALSE_CLAIM_RISK.md.semantic, PUBLIC_COPY_CHANGE_GUIDE.md.semantic, LTD_ADAPTER_IMPLEMENTATION_GUIDE.md.semantic, RELEASE_RUNBOOK.md.semantic, PREMIUM_FLAGSHIP_POLISH_REPORT.md.semantic, completion_backlog_clear, final_next_actions, bug_register
...
- Required completion artifacts: missing 22 artifacts: ABSOLUTE_GAP_AUDIT.md, MISSED_POTENTIAL_AUDIT.md, USER_WISH_DESIGN_EXPANSION.md, LTD_COMPLETION_MAP.md, ABSOLUTE_PRODUCT_COMPLETION_PLAN.md, FEEDBACK_TO_IMPLEMENTATION_LOOP.md, KARMA_FORGE_PRODUCT_AND_IMPLEMENTATION_LOOP.md, PACKAGE_MANAGEMENT_AND_PUBLIC_PACKAGE_BROWSER.md, MOBILE_PWA_PRODUCT_SPEC.md, HORIZON_MVP_COMPLETION_MAP.yaml, COMPLETION_BACKLOG.yaml, E2E_TEST_PLAN.md, E2E_RESULTS.generated.json, VERIFICATION_COMMANDS.md, VERIFICATION_RESULTS.generated.json, DEV_CHANGE_GUIDE.md, FALSE_CLAIM_RISK.md, PUBLIC_COPY_CHANGE_GUIDE.md, LTD_ADAPTER_IMPLEMENTATION_GUIDE.md, RELEASE_RUNBOOK.md, PREMIUM_FLAGSHIP_POLISH_REPORT.md, FINAL_NEXT_ACTIONS.yaml (/docker/chummercomplete/_completion/chummer6_absolute_completion)
- Run ledger: parsed_lines=14 current_run_lines=0 structured_lines=0 pass0_seen=False evidence_rows=0 total_lines=14 (/docker/chummercomplete/_completion/chummer6_absolute_completion/RUN_LEDGER.jsonl)
- Branch policy alignment: mismatches=/docker/chummercomplete/Chummer6:inventory=main, /docker/chummercomplete/Chummer6:live=main, /docker/EA:inventory=main, /docker/EA:live=main, /docker/fleet:inventory=main, /docker/fleet:live=main, /docker/chummercomplete/chummer.run-services:inventory=main, /docker/chummercomplete/chummer.run-services:live=main, /docker/chummercomplete/chummer-core-engine:inventory=fleet/core, /docker/chummercomplete/chummer-core-engine:live=fleet/core, /docker/chummercomplete/chummer-presentation:inventory=main, /docker/chummercomplete/chummer-presentation:live=main, /docker/chummercomplete/chummer-design:inventory=fleet/ea/newbranch, /docker/chummercomplete/chummer-design:live=fleet/ea/newbranch, /docker/chummercomplete/chummer-hub-registry:inventory=main, /docker/chummercomplete/chummer-hub-registry:live=main, /docker/chummercomplete/chummer-play:inventory=fleet/mobile, /docker/chummercomplete/chummer-play:live=fleet/mobile, /docker/chummercomplete/chummer-ui-kit:inventory=fleet/ui-kit, /docker/chummercomplete/chummer-ui-kit:live=fleet/ui-kit, /docker/fleet/repos/chummer-media-factory:inventory=fleet/media-factory, /docker/fleet/repos/chummer-media-factory:live=fleet/media-factory, /docker/chummer5a:inventory=Docker, /docker/chummer5a:live=Docker, /docker/fleet/repos/chummer4:inventory=master, /docker/fleet/repos/chummer4:live=master (/docker/chummercomplete/_completion/chummer6_absolute_completion/REPO_INVENTORY.yaml)
...
- Horizon MVP completion map semantics: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/HORIZON_MVP_COMPLETION_MAP.yaml)
...
- Product doc truth coverage: missing=/docker/chummercomplete/Chummer6/DOWNLOAD.md:guide_section_incomplete, /docker/chummercomplete/Chummer6/STATUS.md:guide_section_incomplete (/docker/chummercomplete/Chummer6)
...
- ABSOLUTE_GAP_AUDIT.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/ABSOLUTE_GAP_AUDIT.md)
- MISSED_POTENTIAL_AUDIT.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/MISSED_POTENTIAL_AUDIT.md)
- USER_WISH_DESIGN_EXPANSION.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/USER_WISH_DESIGN_EXPANSION.md)
- LTD_COMPLETION_MAP.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/LTD_COMPLETION_MAP.md)
- ABSOLUTE_PRODUCT_COMPLETION_PLAN.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/ABSOLUTE_PRODUCT_COMPLETION_PLAN.md)
- FEEDBACK_TO_IMPLEMENTATION_LOOP.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/FEEDBACK_TO_IMPLEMENTATION_LOOP.md)
- KARMA_FORGE_PRODUCT_AND_IMPLEMENTATION_LOOP.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/KARMA_FORGE_PRODUCT_AND_IMPLEMENTATION_LOOP.md)
- PACKAGE_MANAGEMENT_AND_PUBLIC_PACKAGE_BROWSER.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/PACKAGE_MANAGEMENT_AND_PUBLIC_PACKAGE_BROWSER.md)
- MOBILE_PWA_PRODUCT_SPEC.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/MOBILE_PWA_PRODUCT_SPEC.md)
- E2E_TEST_PLAN.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/E2E_TEST_PLAN.md)
- VERIFICATION_COMMANDS.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/VERIFICATION_COMMANDS.md)
- DEV_CHANGE_GUIDE.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/DEV_CHANGE_GUIDE.md)
- FALSE_CLAIM_RISK.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/FALSE_CLAIM_RISK.md)
- PUBLIC_COPY_CHANGE_GUIDE.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/PUBLIC_COPY_CHANGE_GUIDE.md)
- LTD_ADAPTER_IMPLEMENTATION_GUIDE.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/LTD_ADAPTER_IMPLEMENTATION_GUIDE.md)
- RELEASE_RUNBOOK.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/RELEASE_RUNBOOK.md)
- PREMIUM_FLAGSHIP_POLISH_REPORT.md semantic coverage: missing (/docker/chummercomplete/_completion/chummer6_absolute_completion/PREMIUM_FLAGSHIP_POLISH_REPORT.md)
...
- Bug and gap register: open_p0_p1=5 (/docker/chummercomplete/_completion/chummer6_absolute_completion/BUG_AND_GAP_REGISTER.yaml)
