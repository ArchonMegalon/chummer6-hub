...
* `knowledge-fabric` - `Prompting Systems`, `Documentation.AI`, `AI Magicx`, `1min.AI`, `BrowserAct`, `Blip AI`, and `Paperguide` may build, audit, capture, or cite derived projections, but core-owned rules and receipts remain authoritative
