...
[ApiController]
[Route("api/internal/avatar/provider")]
    ...
    AvatarGatewayCredentialPolicy credentials) : IAsyncAuthorizationFilter, IOrderedFilter
{
    ...
    public Task OnAuthorizationAsync(AuthorizationFilterContext context)
    {
        ...
        bool ready = provider ? credentials.ProviderReady : credentials.ContextMintReady;
        bool authorized = provider
