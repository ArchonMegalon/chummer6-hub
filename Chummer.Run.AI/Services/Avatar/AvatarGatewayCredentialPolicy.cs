...
public sealed class AvatarGatewayCredentialPolicy(IConfiguration configuration)
{
    ...
    public const string ProviderEnabledConfigurationKey = "CHUMMER_AVATAR_GATEWAY_PROVIDER_ENABLED";
    ...
    public bool ProviderEnabled => string.Equals(
        configuration[ProviderEnabledConfigurationKey]?.Trim(),
        "true",
        StringComparison.Ordinal);

    public bool ProviderReady => ProviderEnabled
        && DeploymentTopologyReady
