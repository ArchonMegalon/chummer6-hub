...
REQUIRED_DOCS = [
    ...
    "BLACK_LEDGER_STATS_SPEC.md",
    "KARMA_FORGE_PUBLIC_HUB_SPEC.md",
    "PUBLIC_HOMEPAGE_COMPONENT_MAP.yaml",
    "BLACK_LEDGER_PUBLIC_ROUTE_SPEC.yaml",
    "PUBLIC_VISUAL_SYSTEM_BLACK_LEDGER_GLASS.md",
]
