...
CAPABILITY_ASSESSMENTS: dict[str, dict[str, Any]] = {
    ...
    "runsite-scene-render": _assessment(
        ...
        "Chummer.Run.Api/Services/Community/RunsiteOrientationRequestComposerService.cs",
        "Chummer.Run.Api/Services/Community/RunsiteOrientationArtifactRequestBridgeService.cs",
    ...
    "propertyquarry-apartment-video": _assessment(
        ...
        "Chummer.Run.Api/Services/Community/PropertyquarryApartmentVideoArtifactRequestBridgeService.cs",
