...
def important_work_items() -> list[ImportantWorkItem]:
    return [
        ...
        ImportantWorkItem(
            ...
            next_action="Run the generated story through the Humanizer lane before FlipLink/book, audiobook, video, and Alice ingestion; keep advanced steering collapsed by default.",
