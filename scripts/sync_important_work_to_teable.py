...
def important_work_items() -> list[ImportantWorkItem]:
    return [
        ...
        ImportantWorkItem(
            ...
            next_action="Remove public AI/provider/proof/check noise, hide Black Ledger until ready, and focus on what Chummer is, downloads, help, and trust.",
            acceptance_gate="A skeptical visitor can understand Chummer in five seconds and sees no internal process language on first-visit pages.",
        ),
        ImportantWorkItem(
            ...
            next_action="Run the humanizer loop over website, help, installer, desktop dialogs, and Origin Dossier output.",
