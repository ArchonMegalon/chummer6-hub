...
DEFAULT_FETCH_TIMEOUT_SECONDS = float(os.environ.get("CHUMMER_LIVE_WINDOWS_INSTALLER_FETCH_TIMEOUT_SECONDS", "60"))
DEFAULT_FETCH_ATTEMPTS = max(1, int(os.environ.get("CHUMMER_LIVE_WINDOWS_INSTALLER_FETCH_ATTEMPTS", "3")))
