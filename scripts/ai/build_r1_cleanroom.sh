...
dotnet build ../chummer-core-engine/Chummer.Contracts/Chummer.Contracts.csproj --nologo --disable-build-servers
dotnet build ../chummer-hub-registry/Chummer.Hub.Registry.Contracts/Chummer.Hub.Registry.Contracts.csproj --nologo --disable-build-servers
dotnet build ../chummer-hub-registry/Chummer.Run.Registry/Chummer.Run.Registry.csproj --nologo --disable-build-servers
dotnet build ../../fleet/repos/chummer-media-factory/src/Chummer.Media.Contracts/Chummer.Media.Contracts.csproj --nologo --disable-build-servers
dotnet build ../../fleet/repos/chummer-media-factory/src/Chummer.Media.Factory.Runtime/Chummer.Media.Factory.Runtime.csproj --nologo --disable-build-servers
