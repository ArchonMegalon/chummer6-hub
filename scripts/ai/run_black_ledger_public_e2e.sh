...
TMP_DIR="$(mktemp -d "${TMP_ROOT}/black-ledger-e2e.XXXXXX")"
SERVER_PID=""
...
BASE_URL="$BASE_URL" npx playwright test \
  tests/public/black-ledger-newsroom.spec.ts \
  tests/public/black-ledger-faction-videos.spec.ts \
  tests/public/black-ledger-globe-render.spec.ts

echo "black-ledger public playwright passed at $BASE_URL"
