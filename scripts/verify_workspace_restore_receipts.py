...
SOURCE_MARKERS: dict[str, list[str]] = {
    ...
    "Chummer.Run.Api/Views/Accounts/Account.cshtml": [
        ...
        "HumanizeStatus(action.Authority, \"hub_entitlement_ledger\")",
        "HumanizeStatus(action.Authority, \"hub_campaign_spine_projection\")",
        "surface.Status.LeadReceiptId",
        ...
        "HumanizeStatus(recovery.RecoverabilityPosture, \"Recoverable with receipt\")",
        "Recovery route: @recovery.RecoveryRoute",
        "@recovery.RecoverySummary",
        "HumanizeStatus(recovery.ContinuePosture, \"Safe to continue with receipt\")",
        "selectedWorkspaceServerPlane.RestoreReceiptStatus.LeadSubjectId",
        ...
        "HumanizeStatus(receipt.ConflictPosture, \"Reviewable conflict\")",
        "HumanizeStatus(receipt.RecoverabilityPosture, \"Recoverable by workspace review\")",
        "Recovery route: @receipt.RecoveryRoute",
        "@receipt.RecoveryHint",
        "@receipt.RecoverySummary",
        "HumanizeStatus(receipt.ContinuePosture, receipt.BlocksContinue ? \"Continue blocked\" : \"Review before continuing\")",
    ],
...
LOCAL_RELEASE_PROOF_RECEIPTS: dict[str, dict[str, object]] = {
    "workspace_restore:provenance": {
        "routes": ["/home/work", "/account/work", "/account/access"],
        "surfaces": [
            "workspace_restore:provenance",
            "workspace_restore:recoverable_actions",
            "workspace_restore",
    ...
    "entitlement_sync:conflict_receipts": {
        "routes": ["/home/work", "/account/work", "/account/access", "/downloads"],
        "surfaces": [
            "entitlement_sync:conflict_receipts",
            "entitlement_sync:recoverable_actions",
            "entitlement_sync",
