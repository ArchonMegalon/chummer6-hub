...
SOURCE_MARKERS: dict[str, list[str]] = {
    ...
    "scripts/launch_artifact_factory_source_pack_batch.py": [
        ...
        "load_recipe_catalog(base_url, token, args.public_host, args.forwarded_proto)",
        'credential-bearing CLI arguments are not supported.',
    ...
    "tests/test_artifact_factory_source_pack_launcher.py": [
        ...
        "test_fails_when_batch_response_required_receipts_drift_from_media_requests",
        "test_fails_when_batch_response_public_shelf_refs_drift_from_media_requests",
        "aggregate_media_request_refs",
    ...
    "Chummer.Run.Api/Services/ArtifactFactoryOrchestrationService.cs": [
        ...
        "artifact factory path ids must be stable public status shelf segments.",
        "artifact factory path ids must not contain traversal, encoded provider delimiters, or encoded path separators.",
        "artifact factory path ids must use stable public route segment characters.",
        "artifact factory bundle refs must be stable public status shelf segments without query strings or fragments.",
        "artifact factory bundle refs must not contain traversal or encoded path separators.",
        "artifact factory bundle refs must use stable public status shelf segments.",
        ...
        "artifact factory output refs must stay on the Chummer public status shelf.",
