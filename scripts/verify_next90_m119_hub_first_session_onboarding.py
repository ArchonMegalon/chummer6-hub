...
SOURCE_MARKERS = {
    ...
    "Chummer.Run.Api/Views/PublicLanding/Home.cshtml": [
        ...
        "Open install setup first",
        "Rules: @PublicText(leadFirstPlayableSession.RuleReadySummary)",
        "Return: @PublicText(leadFirstPlayableSession.ReturnLaneSummary)",
        "Ready: @PublicText(leadFirstPlayableSession.CampaignReadySummary)",
    ...
    "tests/RunServicesSmoke/Program.cs": [
        ...
        'Assert(homeSource.Contains("Open first playable session", StringComparison.Ordinal),',
