...
RAFTER_PIXEFY_FLEET_VERDICT_MD = COMPLETION_ROOT / "RAFTER_PIXEFY_QA_STACK_VERDICT.md"
...
def build_payload() -> dict[str, Any]:
    ...
    elif RAFTER_PIXEFY_FLEET_VERDICT_MD.is_file():
        combined_source = str(RAFTER_PIXEFY_FLEET_VERDICT_MD)
        combined_ready = READY_VERDICT in read_text(RAFTER_PIXEFY_FLEET_VERDICT_MD)
    else:
