...
if [[ "$RUNBOOK_MODE" == "desktop-gate" ]]; then
  ...
  require_path "Chummer.Run.Api/Chummer.Run.Api.csproj"
  require_path "Chummer.Run.Api/Program.cs"
  require_path "Chummer.Run.Api/Controllers/PublicLandingController.cs"
  require_path "Chummer.Portal/downloads/releases.json"
  ...
  require_match "name: release-api-portable" ".github/workflows/desktop-downloads-matrix.yml"
  require_match "name: desktop-download-bundle" ".github/workflows/desktop-downloads-matrix.yml"
  require_match "Chummer.Run.Api/\\*\\*" ".github/workflows/desktop-downloads-matrix.yml"
  require_match "Chummer.Portal/\\*\\*" ".github/workflows/desktop-downloads-matrix.yml"
  require_match "Stage public downloads mirror" ".github/workflows/desktop-downloads-matrix.yml"
  require_match "\\[HttpGet\\(\"/downloads\"\\)\\]" "Chummer.Run.Api/Controllers/PublicLandingController.cs"
  require_match "CHUMMER_DOWNLOADS_SOURCE_ROOT" "docker-compose.public-edge.yml"
  ...
  require_no_match "Chummer.Blazor.Desktop/Chummer.Blazor.Desktop.csproj" ".github/workflows/desktop-downloads-matrix.yml"
  require_no_match "Chummer.Avalonia/Chummer.Avalonia.csproj" ".github/workflows/desktop-downloads-matrix.yml"
...
if [[ "$RUNBOOK_MODE" == "desktop-build" ]]; then
  DESKTOP_PROJECT="${DESKTOP_PROJECT:-${RUNBOOK_ARG_FRAMEWORK:-Chummer.Run.Api/Chummer.Run.Api.csproj}}"
