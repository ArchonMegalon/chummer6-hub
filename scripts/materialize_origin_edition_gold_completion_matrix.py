...
def materialize(evidence_root: Path, output: Path, context: OriginEditionContext | None = None) -> dict[str, Any]:
    ...
    deployed_flags = {
        ...
        "no_fallback_media_verified": deployed_probe.get("no_fallback_media_verified") is True,
        ...
        "watch_artifact_nonempty": deployed_probe.get("watch_artifact_nonempty") is True,
        ...
        "audiobook_share_reachable": deployed_probe.get("audiobook_share_reachable") is True,
        "dossier_share_reachable": deployed_probe.get("dossier_share_reachable") is True,
        "cover_artifact_nonempty": deployed_probe.get("cover_artifact_nonempty") is True,
        "book_artifact_nonempty": deployed_probe.get("book_artifact_nonempty") is True,
        "cover_sha_matches_import": deployed_probe.get("cover_sha_matches_import") is True,
        "book_sha_matches_import": deployed_probe.get("book_sha_matches_import") is True,
        "video_sha_matches_import": deployed_probe.get("video_sha_matches_import") is True,
