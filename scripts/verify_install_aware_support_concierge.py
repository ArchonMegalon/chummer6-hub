...
SOURCE_MARKERS: dict[str, list[str]] = {
    "Chummer.Run.Api/Services/Support/SupportConciergePacketService.cs": [
        ...
        "BuildClosureReadiness(",
        "BuildInstalledToReleaseDelta(",
    ...
    "tests/RunServicesVerification/SupportCrashVerification.cs": [
        ...
        "conciergePacket.SupportClosure.ClosureReadiness.ReporterCanClose",
        "conciergePacket.ReleaseExplainer.InstalledToReleaseDelta.VersionChanges",
        "conciergePacket.ReleaseExplainer.InstalledToReleaseDelta.ArtifactMatchesInstalledDevice",
        "conciergePacket.ReleaseExplainer.CorrectnessBasis.Contains",
        "conciergePacket.PublicTrustWrapper.FirstPartyOnlyTruth",
        "installBackedPacket.IsInstallAware",
        "receipt-claimed-install-only",
        "receiptlessInstallPacket.IsInstallAware",
        "claimed install tuple fields as install-aware truth without an installed-build receipt id",
        "receiptlessInstallPacket.SupportClosure.ClosureReadiness.InstalledBuildComplete",
        "placeholderReceiptPacket.IsInstallAware",
        "placeholder installed-build receipt ids",
        "crossChannelPacket.ReleaseTruth.ChannelAgreesWithInstalledBuild",
        "installed channel and release channel do not agree",
        "unlinkedPacket.IsInstallAware",
        "unknown labels or manifest fallback",
        "unlinkedPacket.ReleaseTruth.ChannelAgreesWithInstalledBuild",
        "installed build truth is incomplete",
    ],
    "scripts/materialize_hub_local_release_proof.py": [
        ...
        "future shards must verify the authenticated concierge packet route",
