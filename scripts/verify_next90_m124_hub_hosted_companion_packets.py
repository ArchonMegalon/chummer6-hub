...
MILESTONE_ID = 124
PACKAGE_TITLE = "Emit install, update, support, restore, campaign, publication, and public-hub CompanionPacket truth from hosted domains."
...
SOURCE_MARKERS = {
    ...
    "Chummer.Tests/HostedCompanionPacketServiceTests.cs": [
        ...
        'Assert.Contains(packetBundle.PublicHubPackets, item => string.Equals(item.OwningDomain, "public_hub", StringComparison.Ordinal)',
    ],
    ...
    "scripts/verify_next90_m124_hub_hosted_companion_packets.py": [
        ...
        'print("next90 m124 hub hosted companion packets proof passed")',
    ],
...
FLEET_QUEUE_STAGING_PATH = Path(os.environ.get("CHUMMER_NEXT90_M124_QUEUE_STAGING", "/docker/fleet/.codex-studio/published/NEXT_90_DAY_QUEUE_STAGING.generated.yaml"))
DESIGN_QUEUE_STAGING_PATH = Path(os.environ.get("CHUMMER_NEXT90_M124_DESIGN_QUEUE_STAGING", "/docker/chummercomplete/chummer-design-m114/products/chummer/NEXT_90_DAY_QUEUE_STAGING.generated.yaml"))
PROOF_PATH = ROOT / ".codex-studio" / "published" / "NEXT90_M124_HUB_HOSTED_COMPANION_PACKETS.generated.json"
...
def main() -> int:
    ...
    for relative_path, markers in SOURCE_MARKERS.items():
        ...
        if relative_path != "scripts/verify_next90_m124_hub_hosted_companion_packets.py":
            for forbidden in FORBIDDEN_PROOF_MARKERS:
                if forbidden in text:
                    missing.append(f"{relative_path}: forbidden marker {forbidden}")

    materializer = ROOT / "scripts" / "materialize_next90_m124_hub_hosted_companion_packets_proof.py"
