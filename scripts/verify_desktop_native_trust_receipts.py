...
CURRENT_LOCAL_PROOF_FLOOR_COMMIT = "0bc0c858"
CURRENT_LOCAL_PROOF_FLOOR_SUBJECT = "test(hub): tighten M102 native support proof guard"
...
REQUIRED_SOURCE_MARKERS = {
    Path("Chummer.Run.Api/Controllers/InstallLinkingController.cs"): [
        ...
        "item.NeedsInstallUpdate || item.FixReadyOnLinkedInstall",
        ...
        "Desktop requested action ({posture}): {trimmed}",
    ...
    Path("tests/RunServicesVerification/InstallLinkingContinuationVerification.cs"): [
        ...
        "Native support follow-through should route update and verification actions back to the grant-bound continuation endpoint.",
        ...
        "Native support continuation should give the desktop app a grant-bound primary action after filing support.",
