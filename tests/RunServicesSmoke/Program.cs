...
async Task VerifyPublicLandingProjectionAsync()
{
    ...
    Assert(homeSource.Contains("Work, return, and roadmap", StringComparison.Ordinal), "home should collapse deeper work surfaces behind a calmer secondary disclosure.");
