...
class DesktopNativeTrustReceiptTests(unittest.TestCase):
    ...
    def test_verifier_default_current_floor_matches_latest_canonical_guard(self) -> None:
        ...
        self.assertEqual("ed611d1a", verifier._current_local_proof_floor_commit())
        self.assertEqual(
            "Tighten M102 support install truth matching",
        ...
        self.assertTrue(
            any("commit ed611d1a tightens M102 support install truth matching" in value for value in verifier.REQUIRED_CANONICAL_QUEUE_LISTS["proof"])
        )
        self.assertTrue(
            any("commit ed611d1a tightens M102 support install truth matching" in value for value in verifier.REQUIRED_CANONICAL_REGISTRY_LISTS["evidence"])
        )
