...
internal static class InstallLinkingContinuationVerification
{
    public static void Run()
    {
        ...
        try
        {
            ...
            File.WriteAllText(
                ...
                """
                {
                  ...
                  "flagship_readiness_audit": {
                    "reason": "desktop client coverage is still missing from the current flagship readiness proof.",
                    "warning_coverage_keys": ["desktop_client"],
                    "scoped_warning_coverage_keys": [],
            ...
            VerificationAssert.True(!channelOnlyHelp.PrimaryActionHref.StartsWith("/account/access", StringComparison.OrdinalIgnoreCase), "Channel-only install help should not route reporter-ready support follow-through into Installs without installed build and device truth.");
            ...
            VerificationAssert.True(!response.SupportCases[0].NextSafeAction.Contains("Open installs", StringComparison.OrdinalIgnoreCase), "Native support follow-through should not tell the desktop app to open Installs.");
            ...
            VerificationAssert.True(!nativeSupport.NextSafeAction.Contains("Open installs", StringComparison.OrdinalIgnoreCase), "New native support cases should not tell the desktop app to open Installs.");
