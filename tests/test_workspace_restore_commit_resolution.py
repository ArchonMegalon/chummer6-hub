...
class WorkspaceRestoreCommitResolutionTests(unittest.TestCase):
    def test_default_required_commits_include_closed_package_hardening_commit(self) -> None:
        ...
        self.assertIn('"d00cf74c"', script_text)
        self.assertIn("commit d00cf74c tightens the M105 campaign OS proof guard", script_text)
        self.assertIn('"049e2938"', script_text)
        self.assertIn("commit 049e2938 pins the M105 campaign proof guard", script_text)
        self.assertIn('"58edeea6"', script_text)
        ...
        self.assertIn('"c6f0439e"', script_text)
        ...
        self.assertIn('"3eb87a75"', script_text)
        self.assertIn("commit 3eb87a75 pins the M105 workspace proof floor guard", script_text)
        self.assertIn('"44bada17"', script_text)
        self.assertIn("commit 44bada17 pins the M105 workspace queue scope proof", script_text)
        self.assertIn('"31b76424"', script_text)
        self.assertIn("commit 31b76424 tightens the M105 workspace materializer proof", script_text)
        self.assertIn('"121f3571"', script_text)
        ...
        self.assertIn('"2f85eb13"', script_text)
        self.assertIn("commit 2f85eb13 hardens M105 restore conflict recovery receipts", script_text)
        self.assertIn('"8c718c33"', script_text)
        ...
        self.assertIn('"ad34bd41"', script_text)
        ...
        self.assertIn('"417946f4"', script_text)
        self.assertIn("commit 417946f4 pins the M105 workspace proof floor", script_text)
        self.assertIn('"e0960698"', script_text)
        self.assertIn("commit e0960698 tightens the M105 workspace telemetry proof guard", script_text)
        ...
        self.assertIn('"87115e9c"', script_text)
        ...
        self.assertIn('"cfc7ec67"', script_text)
        self.assertIn("commit cfc7ec67 tightens M105 restore action route proof", script_text)
