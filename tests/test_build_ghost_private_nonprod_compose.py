...
def test_governed_provider_slots_are_runtime_only_and_cannot_enable_remote_execution():
    ...
    assert "CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_PROVIDER: ${CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_PROVIDER-avatario}" in ai
    assert "CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_NAME: ${CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_NAME-Amelia}" in ai
    assert "CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_ASSET_PATH: ${CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_ASSET_PATH-/live-avatars/avatars/Amelia.jpg}" in ai
    assert "CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_READBACK_DIGEST: ${CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_READBACK_DIGEST-}" in ai
    assert "CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_READBACK_RECEIPT_JSON: ${CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_READBACK_RECEIPT_JSON-}" in ai
    assert "CHUMMER_BUILD_GHOST_TOUGH_TONGUE_MODEL_PROVIDER: ${CHUMMER_BUILD_GHOST_TOUGH_TONGUE_MODEL_PROVIDER-Landmass}" in ai
    assert "CHUMMER_BUILD_GHOST_TOUGH_TONGUE_MODEL_ID: ${CHUMMER_BUILD_GHOST_TOUGH_TONGUE_MODEL_ID-gemini}" in ai
    assert "CHUMMER_BUILD_GHOST_TOUGH_TONGUE_ALLOW_LEGACY_CASCADE: ${CHUMMER_BUILD_GHOST_TOUGH_TONGUE_ALLOW_LEGACY_CASCADE-false}" in ai
...
def test_default_unconfigured_contract_renders_every_service_fail_closed_without_provider_io():
    ...
    assert ai["environment"]["CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_ASSET_PATH"] == "/live-avatars/avatars/Amelia.jpg"
    assert ai["environment"]["CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_READBACK_DIGEST"] == ""
    assert ai["environment"]["CHUMMER_BUILD_GHOST_TOUGH_TONGUE_AVATAR_READBACK_RECEIPT_JSON"] == ""
    assert ai["environment"]["CHUMMER_BUILD_GHOST_TOUGH_TONGUE_MODEL_PROVIDER"] == "Landmass"
    assert ai["environment"]["CHUMMER_BUILD_GHOST_TOUGH_TONGUE_MODEL_ID"] == "gemini"
    assert ai["environment"]["CHUMMER_BUILD_GHOST_TOUGH_TONGUE_ALLOW_LEGACY_CASCADE"] == "false"
