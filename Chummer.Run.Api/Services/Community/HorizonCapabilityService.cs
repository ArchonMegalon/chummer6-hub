...
public sealed class HorizonCapabilityService
{
    ...
    [
        ...
        new(
            ...
            InternalProviderLane: "EA scene render skill / MagicAI omagic pool",
            FreeWeeklyLimit: 0,
        ...
        new(
            HorizonId: "propertyquarry",
            CapabilityId: "propertyquarry-apartment-video",
            ArtifactKind: "apartment_video",
            PublicLabel: "Apartment Video",
            CapabilitySlot: "property_video_render",
            InternalProviderLane: "EA property video skill / MagicAI omagic pool / human review",
            FreeWeeklyLimit: 0,
            SupporterWeeklyLimit: 2,
            RequiresAuthentication: true,
            PublicVisible: false,
        ...
        new(
            HorizonId: "black-ledger",
            CapabilityId: "black-ledger-viewer-network",
            ArtifactKind: "viewer_network",
            PublicLabel: "3D Tour",
            CapabilitySlot: "public_viewer_handoff",
            InternalProviderLane: "Crezlo Tours / 3DVista / Matterport",
            FreeWeeklyLimit: 0,
            SupporterWeeklyLimit: 0,
            RequiresAuthentication: false,
