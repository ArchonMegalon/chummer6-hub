...
public sealed class ArtifactFactoryOrchestrationService
{
    ...
    private static readonly IReadOnlyDictionary<string, ArtifactFactoryRecipe> Recipes =
        new Dictionary<string, ArtifactFactoryRecipe>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["campaign_cold_open"] = new(
                ...
                RequiredAnchorDescription: "a campaign id or campaign public status shelf ref"),
            ["mission_briefing"] = new(
                ...
                RequiredAnchorDescription: "a mission id or mission public status shelf ref")
        };
    ...
    private static void RejectUnsafePublicShelfRef(string sourcePackId, string publicShelfRef, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe public status shelf {fieldName} '{publicShelfRef}'; artifact factory bundle refs must be stable public status shelf segments without query strings or fragments.");
        }
    ...
    private static void RejectRecipeShelfAnchorShape(string sourcePackId, string family, string publicShelfRef, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe public status shelf {fieldName} '{publicShelfRef}'; publication bundle anchors must resolve to one publication segment with an optional bundles shelf.");
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe public status shelf {fieldName} '{publicShelfRef}'; support bundle anchors must resolve to exactly one support case segment.");
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe public status shelf {fieldName} '{publicShelfRef}'; fix bundle anchors must resolve to exactly one support case or release artifact segment.");
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe public status shelf {fieldName} '{publicShelfRef}'; campaign cold-open anchors must resolve to /artifacts/campaigns/{{campaignId}}/cold-open with an optional bundles shelf.");
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe public status shelf {fieldName} '{publicShelfRef}'; mission briefing anchors must resolve to /artifacts/missions/{{missionId}}/briefing with an optional bundles shelf.");
        }
    }
