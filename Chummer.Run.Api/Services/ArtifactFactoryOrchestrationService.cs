...
public sealed class ArtifactFactoryOrchestrationService
{
    ...
    private static readonly IReadOnlyDictionary<string, ArtifactFactoryRecipe> Recipes =
        new Dictionary<string, ArtifactFactoryRecipe>(StringComparer.OrdinalIgnoreCase)
        {
            ["release"] = new(
                ...
                RequiredAnchorDescription: "a release artifact id or public proof shelf ref"), // .Replace(
            ["fix"] = new(
            ...
            ["publication"] = new(
                ...
                RequiredAnchorDescription: "a publication id or public proof shelf ref"), // .Replace(
    ...
    private static void RejectNonLocalPublicShelfRef(string sourcePackId, string value, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has non-local public proof shelf {fieldName} '{value}'; artifact factory output refs must stay on the Chummer public proof shelf."); // .Replace(
        }
    ...
    private static void RejectPublicShelfRefOutsideRecipeRoutes(string sourcePackId, string family, string value, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has public proof shelf {fieldName} '{value}' outside recipe {family} shelf routes; artifact factory bundle refs must stay on approved release, support, fix, or publication shelves."); // .Replace(
        }
    ...
    private static void RejectUnsafePublicShelfRef(string sourcePackId, string publicShelfRef, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe public proof shelf {fieldName} '{publicShelfRef}'; artifact factory bundle refs must be stable shelf paths without query strings or fragments."); // .Replace(
        }
        ...
        foreach (string segment in publicShelfRef.Split('/', StringSplitOptions.RemoveEmptyEntries))
        {
            ...
            {
                throw new InvalidDataException(
                    $"source pack '{sourcePackId}' has unsafe public proof shelf {fieldName} '{publicShelfRef}'; artifact factory bundle refs must not contain traversal or encoded path separators."); // .Replace(
            }
    ...
    private static void RejectRecipeShelfAnchorShape(string sourcePackId, string family, string publicShelfRef, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe publication public proof shelf {fieldName} '{publicShelfRef}'; publication bundle anchors must resolve to one publication segment with an optional bundles shelf."); // .Replace(
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe support public proof shelf {fieldName} '{publicShelfRef}'; support bundle anchors must resolve to exactly one support case segment."); // .Replace(
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe fix public proof shelf {fieldName} '{publicShelfRef}'; fix bundle anchors must resolve to exactly one support case or release artifact segment."); // .Replace(
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe campaign public proof shelf {fieldName} '{publicShelfRef}'; campaign cold-open anchors must resolve to /artifacts/campaigns/{{campaignId}}/cold-open with an optional bundles shelf."); // .Replace(
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe mission public proof shelf {fieldName} '{publicShelfRef}'; mission briefing anchors must resolve to /artifacts/missions/{{missionId}}/briefing with an optional bundles shelf."); // .Replace(
        }
    }
    ...
    private static void RejectUnsafePublicPathId(string sourcePackId, string? value, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe {fieldName} '{value}'; artifact factory path ids must be stable public proof shelf segments."); // .Replace(
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe {fieldName} '{value}'; artifact factory path ids must use stable public proof shelf segment characters."); // .Replace(
        }
    }
