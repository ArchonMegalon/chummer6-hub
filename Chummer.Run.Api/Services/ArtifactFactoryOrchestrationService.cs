...
public sealed class ArtifactFactoryOrchestrationService
{
    ...
    private static readonly IReadOnlyDictionary<string, ArtifactFactoryRecipe> Recipes =
        new Dictionary<string, ArtifactFactoryRecipe>(StringComparer.OrdinalIgnoreCase)
        {
            ["release"] = new(
                ...
                RequiredAnchorDescription: "a release artifact id or public route ref"),
            ["fix"] = new(
            ...
            ["publication"] = new(
                ...
                RequiredAnchorDescription: "a publication id or public route ref"),
            ["campaign_cold_open"] = new(
                ...
                RequiredAnchorDescription: "a campaign id or campaign public route ref"),
            ["mission_briefing"] = new(
                ...
                RequiredAnchorDescription: "a mission id or mission public route ref")
        };
    ...
    private static void RejectNonLocalPublicShelfRef(string sourcePackId, string value, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has non-local public route {fieldName} '{value}'; artifact factory output refs must stay on the Chummer public route.");
        }
    ...
    private static void RejectPublicShelfRefOutsideRecipeRoutes(string sourcePackId, string family, string value, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has public route {fieldName} '{value}' outside recipe {family} shelf routes; artifact factory bundle refs must stay on approved release, support, fix, or publication shelves.");
        }
    ...
    private static void RejectUnsafePublicShelfRef(string sourcePackId, string publicShelfRef, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe public route {fieldName} '{publicShelfRef}'; artifact factory bundle refs must be stable public paths without query strings or fragments.");
        }
        ...
        foreach (string segment in publicShelfRef.Split('/', StringSplitOptions.RemoveEmptyEntries))
        {
            ...
            {
                throw new InvalidDataException(
                    $"source pack '{sourcePackId}' has unsafe public route {fieldName} '{publicShelfRef}'; artifact factory bundle refs must not contain traversal or encoded path separators.");
            }

            if (!IsStablePublicShelfSegment(decodedSegment))
            {
                throw new InvalidDataException(
                    $"source pack '{sourcePackId}' has unsafe public route {fieldName} '{publicShelfRef}'; artifact factory bundle refs must use stable public route segment characters.");
            }
        }
    }
    ...
    private static void RejectReleaseBundleShelfAnchorShape(string sourcePackId, string publicShelfRef, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe release public route {fieldName} '{publicShelfRef}'; release bundle anchors must resolve to exactly one release artifact segment.");
        }
    }
    ...
    private static void RejectRecipeShelfAnchorShape(string sourcePackId, string family, string publicShelfRef, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe publication public route {fieldName} '{publicShelfRef}'; publication bundle anchors must resolve to one publication segment with an optional bundles shelf.");
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe support public route {fieldName} '{publicShelfRef}'; support bundle anchors must resolve to exactly one support case segment.");
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe fix public route {fieldName} '{publicShelfRef}'; fix bundle anchors must resolve to exactly one support case or release artifact segment.");
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe campaign public route {fieldName} '{publicShelfRef}'; campaign cold-open anchors must resolve to /artifacts/campaigns/{{campaignId}}/cold-open with an optional bundles shelf.");
        }
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe mission public route {fieldName} '{publicShelfRef}'; mission briefing anchors must resolve to /artifacts/missions/{{missionId}}/briefing with an optional bundles shelf.");
        }
    }
    ...
    private static void RejectUnsafePublicPathId(string sourcePackId, string? value, string fieldName)
    {
        ...
        {
            throw new InvalidDataException(
                $"source pack '{sourcePackId}' has unsafe {fieldName} '{value}'; artifact factory path ids must be stable public route segments.");
        }
