...
public sealed class PublicSignalOperationsService
{
    ...
    public string LoadArtifactJson()
    {
        ...
        JsonObject artifact = new()
        {
            ...
            ["consentSummary"] = "Follow-up messages wait until participation preferences are connected.",
            ["queueStatusLabel"] = SanitizePublicArtifactText(packet.QueueStatusLabel),
            ["queueSummary"] = "No follow-up is sent until participation preferences and Changelog are ready.",
