...
internal static class DesktopInstallRail
{
        ...
        bool recoveryMode)
    {
        ...
        return new DesktopInstallContinuationReceipt(
            ...
            RollbackAction: "If update or setup fails, keep the previous installed copy and return to Installs or support for this same linked copy. Keep the fix, update, rollback, and verification on this same linked install.",
