...
internal static class DesktopInstallRail
{
    ...
    // Marker retained for desktop native trust verification: Support stays with this install path.
    private const string SupportStaysOnSameInstallPathMarker = "Support stays with this install path";
        ...
        bool recoveryMode)
    {
        ...
        return new DesktopInstallContinuationReceipt(
            ...
            RollbackAction: "If update or setup fails, keep the previous installed copy and return to Installs or tracked support for this same linked copy. Keep the fix, update, rollback, and verification on this same linked install.",
